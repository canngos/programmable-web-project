"""
Validation schemas for booking and ticket related requests.
"""
...
class PassengerSchema(Schema):
    """Schema for a passenger ticket payload."""
...
class BookTicketsSchema(Schema):
    """Schema for booking tickets request payload."""
...
class SeatAvailabilityQuerySchema(Schema):
    """Schema for seat availability query parameters."""
